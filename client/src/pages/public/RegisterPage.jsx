...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate password constraints: at least one letter and one number
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} required
                  className="w-full bg-surface-container-highest border-transparent rounded-lg px-4 py-2.5 text-on-surface placeholder:text-outline-variant input-focus-ring transition-shadow" placeholder="leader@example.com" />
              </div>
